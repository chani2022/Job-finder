...
class GetCollectionSecteurActiviteControllerTest extends ApiTestCase
{
     ...
     */
    public function testGetCollectionSecteurActivite(?string $roles, bool $access): void
    {
        /** @var User */
        ...
        $this->client->request('GET', '/api/secteur_activites');
