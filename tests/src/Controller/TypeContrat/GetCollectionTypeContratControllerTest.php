...
class GetCollectionTypeContratControllerTest extends ApiTestCase
{
     ...
     */
    public function testGetCollectionTypeContrat(?string $roles, bool $access): void
    {
        /** @var User */
        ...
        $this->client->request('GET', '/api/type_contrats');
