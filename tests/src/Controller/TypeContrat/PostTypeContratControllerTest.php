...
class PostTypeContratControllerTest extends ApiTestCase
{
     ...
     */
    public function testPostAuthorizedTypeContrat(?string $roles, bool $access): void
    {
        /** @var User */
        ...
        $this->client->request('POST', '/api/type_contrats', [
            "json" => [
                'type_contrat' => 'cdd'
            ]
        ]);
     ...
     */
    public function testPostValidDataTypeContrat(array $data): void
    {
        $this->myLogUser();
    ...
    public function testUniqueTypeContrat(): void
    {
        $this->myLogUser();
