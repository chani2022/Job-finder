...
class PostNiveauEtudeControllerTest extends ApiTestCase
{
     ...
     */
    public function testPostAuthorizedNiveauEtude(?string $roles, bool $access): void
    {
        /** @var User */
        ...
        $this->client->request('POST', '/api/niveau_etudes', [
            "json" => [
                'niveau_etude' => 'bacc'
            ]
        ]);
     ...
     */
    public function testPostValidDataNiveauEtude(array $data): void
    {
        $this->myLogUser();
